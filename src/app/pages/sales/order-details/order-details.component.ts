      ...
      content: [
        {
          columns: [
            ...
            [
              ...
              {
                width: 'auto',
                text: `Email: info.medicinedipo.com`,
                style: 'p',
              },
            ],
            [
  ...
  dataTableForPdfMake() {
    ...
    this.order.orderedItems.forEach((m, i) => {
      const res = [
        ...
        {
          text: m.discountAmount ? `${m.discountAmount}%` : '-',
          style: 'tableBody',
          borderColor: ['#eee', '#eee', '#eee', '#eee'],
        },
        {
      ...
      table: {
        ...
        body: [
          [
            ...
            {
              text: `${Number(this.order.subTotal.toFixed(2))} TK`,
              style: 'tableBody',
              borderColor: ['#eee', '#eee', '#eee', '#eee'],
            },
          ],
          ...
          [
            ...
            {
              text: `${Number(this.order.grandTotal.toFixed(2))} TK`,
              style: 'tableBody',
              borderColor: ['#eee', '#eee', '#eee', '#eee'],
            },
          ],
